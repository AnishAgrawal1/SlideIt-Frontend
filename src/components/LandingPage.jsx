  ...
  return (
    <div name='home' className=' w-full h-screen top-[90px] text-white'>
      ...
      <div className='max-w-[800px] mt-[-96px] w-full h-screen mx-auto text-center flex flex-col justify-center'>
        ...
        <p className='text-[#00df9a] md:text-md sm:text-md text-sm z-10 font-bold py-2 pr-1'>
          WORK.
        </p>
        <p className='text-white md:text-md sm:text-md text-sm z-10 font-bold py-2 px-1'>
          Make it
        ...
        <div className='flex z-10 justify-center items-center'>
          ...
          <Typed
          className='md:text-3xl sm:text-2xl text-xl font-bold md:pl-4 pl-1 text-[#00df9a]'
        ...
        <RouteLink to='/signin' className='z-10'><button className='bg-[#00df9a] w-[200px] hover:bg-[#00df98bc] z-10 rounded-md font-medium my-6 mx-auto py-3 text-black'><Center><Flex><Text pr='3'>Start Sliding</Text><Center><AiOutlineArrowRight size={20}/></Center></Flex></Center></button></RouteLink>
